...
const makeDesktopStyles = () => StyleSheet.create({
  ...
  rail: { width: 64, backgroundColor: themeMode() === 'light' ? '#e8ebef' : colors.inputBg, borderRightWidth: 1, borderRightColor: colors.border, alignItems: 'center', paddingVertical: 14 },
  ...
  railButtonActive: { backgroundColor: themeMode() === 'light' ? '#ffffff' : colors.card },
  railSettings: { marginBottom: 10 },
  railVersion: { color: colors.textMuted, fontSize: 9 },
  conversations: { width: 304, borderRightWidth: 1, borderRightColor: colors.border, backgroundColor: themeMode() === 'light' ? '#f8f9fb' : colors.bg },
