...
ck('position from anchorRowMenu with the measured layer size and safe-area insets', menu.includes('anchorRowMenu({') && menu.includes('viewportWidth: area?.width ?? win.width') && menu.includes('insets: touch ? { top: safe.paddingTop') && menu.includes("useModalSafePadding('fullScreen')"));
