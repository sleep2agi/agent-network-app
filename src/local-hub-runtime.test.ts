...
const checks: Array<[string, boolean]> = [
  ...
  ['packaged local workspace proves public node and task flow', rust.includes('"name": "report_status"') && rust.includes('reported node is missing from public status API') && rust.includes('public task dispatch returned') && rust.includes('dispatched task is missing from public tasks API')],
